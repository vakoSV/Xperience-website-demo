  ...
  const reports = [
    {
      ...
      descriptionKa: 'ამ ანგარიშში წარმოდგენილია ციფრული ტრანსფორმაციის ახალი ტრენდები და რეკომენდაციები ბიზნესებისთვის.',
      descriptionEn: 'This report presents new trends in digital transformation and recommendations for businesses.',
      date: '2024-04-15',
    ...
    },
    {
      ...
      descriptionKa: 'კლაუდ ტექნოლოგიის სრული ანალიზი და მისი გამოყენება სხვადსხვა ინდუსტრიებში.',
      descriptionEn: 'Complete analysis of cloud technology and its applications across various industries.',
      date: '2024-04-10',
      author: 'Xperience Research Team',
      pages: 52,
      fileSize: '3.1 MB',
    },
    {
      ...
      descriptionKa: 'AI-ის გამოყენება ბიზნეს პროცესებში და მისი ეკონომიკური გავლენა.',
      descriptionEn: 'AI applications in business processes and its economic impact.',
      date: '2024-04-05',
      author: 'Xperience Research Team',
      pages: 38,
      fileSize: '2.2 MB',
    ...
    },
    {
      ...
      descriptionKa: 'ბიგ დატა ტექნოლოგიების გამოყენება სხვადსხვა ინდუსტრიებში.',
      descriptionEn: 'Applications of big data technologies across various industries.',
      date: '2024-03-25',
      author: 'Xperience Research Team',
      pages: 48,
      fileSize: '3.0 MB',
      ...
      <section className="py-20 md:py-32">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {reports.map((report) => (
              <Card key={report.id} className="hover:shadow-lg transition-shadow overflow-hidden flex flex-col">
                {/* Header Icon */}
                ...
                <CardContent className="flex-1 flex flex-col">
                  <p className="text-muted-foreground mb-6 line-clamp-3">
                    {language === 'ka' ? report.descriptionKa : report.descriptionEn}
                  </p>
                  ...
                  <div className="space-y-2 mb-6 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2">
                      <FileText size={16} />
                      <span>{report.pages} {t('researchPage.pages')} • {report.fileSize}</span>
                    </div>
                  </div>

                  {/* Download Button */}
                  <Button
                    onClick={() => handleDownload(report.id, language === 'ka' ? report.titleKa : report.titleEn)}
