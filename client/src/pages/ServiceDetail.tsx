...
export default function ServiceDetail() {
  const [match, params] = useRoute(withBase("/services/:id"));
  const { language, t } = useLanguage();
  const routeId = (params as Record<string, string | undefined> | undefined)
    ?.id;
  ...
  const serviceDetails: Record<number, any> = {
    1: {
      ...
      fullDescription:
        "ციფრული ტრანსფორმაცია არის თქვენი ბიზნეს ოპერაციების თანამედროვე ტექნოლოგიებით ოპტიმიზაციის პროცესი.",
      fullDescriptionEn:
        "Digital transformation is the process of optimizing your business operations with modern technologies.",
      benefits: [
    ...
    2: {
      ...
      fullDescription:
        "კლაუდ სოლიუშნები უზრუნველყოფენ მასშტაბირებადობას, უსაფრთხოებას და ხარჯების ეფექტურობას.",
      fullDescriptionEn:
        "Cloud solutions provide scalability, security, and cost efficiency.",
      benefits: [
    ...
    3: {
      ...
      fullDescription:
        "მონაცემების ანალიზი გვეხმარება გამოვიტანოთ ღირებული ინსაითები ბიზნეს გადაწყვეტილებებისთვის.",
      fullDescriptionEn:
        "Data analytics helps extract valuable insights for business decisions.",
      benefits: [
    ...
    4: {
      ...
      fullDescription:
        "კიბერუსაფრთხოება დაცავს თქვენი ციფრული აქტივებს ყველა სახის საფრთხიდან.",
      fullDescriptionEn:
        "Cybersecurity protects your digital assets from all types of threats.",
      benefits: [
    ...
    5: {
      ...
      fullDescription:
        "AI და მანქანური სწავლა ხელოვნური ინტელექტის ძალას გამოიყენებს ბიზნესის ავტომატიზაციისთვის.",
      fullDescriptionEn:
        "AI and machine learning leverage artificial intelligence for business automation.",
      benefits: [
    ...
    6: {
      ...
      fullDescription:
        "კონსულტაციები გთავაზობთ სტრატეგიულ გაიდლაინებს ტექნოლოგიის ინვესტიციებისთვის.",
      fullDescriptionEn:
        "Consulting provides strategic guidance for technology investments.",
      benefits: [
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map(id => {
              ...
              return (
                <Link key={id} href={withBase(`/services/${id}`)}>
                  <a className="group">
